...
if __name__ == '__main__':
    st.markdown("""
                ...
                'ingolstadt7' and unzipit. Dowload other file called 'Test_RL.zip' BUT
                YOU MUSTN'T UNZIP IT.
                When every file is ready you can run the code bellow
                 """)

    st.markdown('-'*17)

    st.code('''model = A2C.load("Test_RL") 
